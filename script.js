    ...
    if (contactForm) {
        ...
        const validateField = function(input) {
            ...
            if (input.hasAttribute('required') && !value) {
                ...
                const fieldName = label ? label.textContent.replace(/[*:]/g, '').trim() : name;
            ...
            if (type === 'email' && value) {
                if (!validateEmail(value)) {
                    showError(input, (document.dir === 'rtl' ? 'يرجى إدخال بريد إلكتروني صحيح' : 'Please enter a valid email address'));
                    return false;
                }
            }
            ...
            if (input.hasAttribute('minlength') && value) {
                ...
                if (value.length < minLength) {
                    showError(input, (document.dir === 'rtl' ? 
            ...
            if (type === 'tel' && value) {
                ...
                if (!phoneRe.test(value)) {
                    showError(input, (document.dir === 'rtl' ? 'يرجى إدخال رقم هاتف صحيح' : 'Please enter a valid phone number'));
                    return false;
                }
            }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '46383590-c034-4137-ba66-b614e3810ec2',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '46383590-c034-4137-ba66-b614e3810ec2';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '46383590-c034-4137-ba66-b614e3810ec2';
